#include "windows/abstract_window.h"

abstract_window::abstract_window(QWidget* parent) : QWidget(parent)
{
}

void abstract_window::setupUI()
{
    // MAIN LAYOUT
...
void abstract_window::setUsername(const QString& username)
{
    _username->setText(username);
}

void abstract_window::setActiveButton(QPushButton* active)
{
